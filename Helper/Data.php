...
namespace Walcart\Otplogin\Helper;

use Twilio\Rest\Client;

/**
 * Class Data
 * @package Walcart\Otplogin\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{

    const OTP_TYPE = 'walcart_otplogin/general/otp_type';
    const OTP_LENGTH = 'walcart_otplogin/general/otp_length';
    const MOBILE_NUMBER = 'walcart_otplogin/api_configuration/mobile_number';
    const SELLER_ID = 'walcart_otplogin/api_configuration/sender_id';
    const AUTHORIZATION_KEY = 'walcart_otplogin/api_configuration/authorization_key';
    const EXPIRE_TIME = 'walcart_otplogin/general/expire_time';
    ...
    public function __construct(
        ...
        \Walcart\Otplogin\Model\OtpFactory $otpFactory,
